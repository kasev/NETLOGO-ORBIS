...
to generate-connections- ;; used to produce the connections from the uncomplete network; instead of generated over and over, these are uploaded from outside
  ask ids with [pop < 1 and count my-links < 2] [
    create-connections-with min-n-of 2 other ids [distance myself]
    ]
  ask ids with [pop > 0] [
