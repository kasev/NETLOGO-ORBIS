...
newsites-own [name wilname pop pop-type former-breed]
...
to generate-and-store-orbwilsites ;; generates a new set of cities, combining features from wilson and orbis
  ask orbcities with [color = yellow or color = green][ ; consider only cities with either given or attributed population
    hatch-newsites 1 [
  ...
  ask wilcities with [count my-out-links = 0] [
    hatch-newsites 1 [
        set name [name] of myself
        set former-breed [breed] of myself
  ...
  ask newsites [
       set shape "circle"
       set size sqrt (pop / 1500)
       set color white
       ]

  set orbwilsites-dataset gis:turtle-dataset newsites
  gis:store-dataset orbwilsites-dataset "generated-data/orbwilsites1"
end
...
51
NIL
generate-and-store-orbwilsites
NIL
1
T
OBSERVER
