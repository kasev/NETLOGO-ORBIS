  ...
  ask churches [
    ...
    ask disseminators with [in-city? = false and travelled-distance < max-distance] [
      while [travelled-distance < max-distance] [
        ...
        set route-to-take [[out-link-to my-new-id] of myself] of my-actual-id
        ;set my-new-id one-of other [link-neighbors] of my-actual-id
        ;set route-to-take one-of [links] my-actual-id my-new-id; with [link-neighbors != my-last-id]  ;with [other-end != my-last-id]  ; with [color != red]
        move-to my-new-id
