...
roads-own [my-end-type my-end-orb-id my-end-e my-ratio my-ratio-distance]
        ...
        [ create-ids 1
          [ set xcor item 0 location
            ...
            [ create-road-with previous-turtle [
                set color 56
                if my-end-type = "road" or my-end-type = "hires" or my-end-type = "ferry" [set my-ratio road-ratio]
                if my-end-type = "oversea" or my-end-type = "slowover" or my-end-type = "coastal" or my-end-type = "overseas" [set my-ratio sea-ratio]
                if my-end-type = "upstream" [set my-ratio river-ratio]
                set my-ratio-distance (link-length * my-ratio)
...
to generate-connections-as-roads ;; used to produce the connections from the uncomplete network; instead of generated over and over, these are uploaded from outside
  ...
  ask roads with [color != 56] ;set my-ratio-distance for just created connections
    [set my-ratio-distance (link-length * road-ratio)]
end
