...
ids-own [my-type my-orb-id my-e pop name my-ratio]
roads-own [my-end-type my-end-orb-id my-end-e my-ratio-distance]
      ...
      foreach but-last vertex [ [point] ->
        ...
        [ create-ids 1
          [ set xcor item 0 location
            ...
            set pop 0
            if my-type = "road" or my-type = "hires" or my-type = "ferry" [set my-ratio road-ratio]
            if my-type = "oversea" or my-type = "slowover" or my-type = "coastal" or my-type = "slowover" [set my-ratio sea-ratio]
            if my-type = "upstream" [set my-ratio river-ratio]
            ifelse previous-turtle = nobody
            [ set first-turtle self ]
            [ create-road-with previous-turtle [
                set color 56
                set my-ratio-distance (link-length * [my-ratio] of end1)
