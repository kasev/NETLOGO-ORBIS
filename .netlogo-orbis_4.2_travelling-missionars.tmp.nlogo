...
to go
  ask churches [
     ...
     if church-age > 100 [set size 3 + (church-age / 100)]
  ...
  ask disseminators with [in-city? = false and travelled-distance < max-distance] [
    set travelled-route one-of [routes] of my-actual-id
    set my-new-id [[other-end] of end1] of travelled-route
    move-to my-new-id
    set my-actual-id my-new-id
    set travelled-distance travelled-distance + [link-length] of travelled-route
